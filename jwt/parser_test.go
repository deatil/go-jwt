...
func Test_SigningMethodHS256_Parse_No_Type(t *testing.T) {
	claims := map[string]string{
		"aud": "example.com",
		"sub": "foo",
	}
	...
	parsed, err := Parse(tokenString, func(t *Token) ([]byte, error) {
		return key, nil
	}, JWTParserOption)
	if err != nil {
		t.Fatal(err)
...
func Test_SigningMethodPS512_Parse_No_Type(t *testing.T) {
	var prikey = ""
	var pubkey = ""
	...
	parsed, err := Parse(tokenString, func(t *Token) (*rsa.PublicKey, error) {
		return publicKey, nil
	})
	if err != nil {
		t.Fatal(err)
...
func Test_SigningMethodRS256_Parse_No_Type(t *testing.T) {
	var prikey = ""
	var pubkey = ""
...
func Test_SigningMethodES256_Parse_No_Type(t *testing.T) {
	privateKey, err := ecdsa.GenerateKey(elliptic.P256(), rand.Reader)
	if err != nil {
		t.Fatal(err)
	}
	...
	parsed, err := Parse(tokenString, func(t *Token) (*ecdsa.PublicKey, error) {
		return publicKey, nil
	})
	if err != nil {
		t.Fatal(err)
...
func Test_SigningMethodEdDSA_Parse_No_Type(t *testing.T) {
	publicKey, privateKey, err := ed25519.GenerateKey(rand.Reader)
	if err != nil {
		t.Fatal(err)
	}
